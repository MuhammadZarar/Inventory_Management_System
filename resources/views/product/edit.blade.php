            ...
            <div class="page-header">
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Juice</li>
                    </ol>
                </nav>
            </div>
            <div class="row">
                <div class="col-md-12 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <h3>Edit Product</h3>
                            <hr>
                            <form id="edit_product_form" class="forms-sample">
                                @csrf
                                        ...
                                        @if (count($category) > '0')
                                            @foreach ($category as $category)
                                                <option value="{{ $category->category_id }}"
                                                    {{ $category->category_id == $product->type ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>Iceream Price</label>
                                        <input type="number" name="price" id="price"
                                            class="form-control form-control-sm" value="{{ $product->price }}" />
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-gradient-primary me-2"
                                    id="edit_product_submit">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
